...
exports.validateUsersUpdate = validateUsersUpdate;
...
const uniqueFields = ['identity', 'username', 'email', 'phone_number'];
const requiredUniqueFields = ['identity', 'username', 'email', 'phone_number'];
...
function isNotUnique(field, value) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const existingUser = yield prismaClient_1.prisma.users.findUnique({
                where: whereClause,
            });
...
// Check the data structure
function validateUsersUpdate(data) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const field of allFields) {
