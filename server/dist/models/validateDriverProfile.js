...
exports.validateDriverProfileUpdate = validateDriverProfileUpdate;
...
const requiredFields = ['userId', 'drivingLicence', 'location'];
...
function isNotUnique(field, value) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const existingUser = yield prismaClient_1.prisma.driver_Profile.findUnique({
                where: {
                    [field]: value,
                },
            });
...
function validateDriverProfile(data) {
    return __awaiter(this, void 0, void 0, function* () {
...
// Check the data structure
function validateDriverProfileUpdate(data) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const field of allFields) {
